...
export interface ApiContactContact extends Schema.CollectionType {
  ...
  attributes: {
    ...
    asunto: Attribute.Text & Attribute.Required;
...
export interface ApiOfertaOferta extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    image: Attribute.Media & Attribute.Required;
    descuento: Attribute.Integer & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductoProducto extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    descripcion: Attribute.Text & Attribute.Required;
    url_image: Attribute.Media & Attribute.Required;
    actual_price: Attribute.Decimal & Attribute.Required;
    antes_price: Attribute.Decimal & Attribute.Required;
    cantidad: Attribute.Integer & Attribute.Required;
    ...
    tallas: Attribute.JSON &
      ...
      Attribute.CustomField<
        ...
        ['XS', 'L', 'M', 'S', 'XL']
      >;
    colores: Attribute.JSON &
      Attribute.Required &
      Attribute.CustomField<
        'plugin::multi-select.multi-select',
        ['Blanco', 'Negro', 'Beige', 'Plomo', 'Lila']
      >;
...
export interface ApiReviewReview extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media & Attribute.Required;
    opinion: Attribute.Text & Attribute.Required;
